// ILI9342 example with embedded color bitmaps in sketch.
...
//  See also https://forum.pjrc.com/threads/35575-Export-for-ILI9342_t3-with-GIMP
  ...
  for(uint8_t r=0; r<4; r++) {
    ...
    for(uint8_t j=0; j<20; j++) {
      tft.drawRGBBitmap(
        ...
        // the RAM-resident-optimized drawRGBBitmap in the ILI9342
